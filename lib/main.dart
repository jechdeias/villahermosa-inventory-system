...
=======
  Widget build(BuildContext context) => MaterialApp(
    ...
    routes: {
      ...
      AppRoutes.adminDashboard: (context) => AdminDashboardScreen(database: database),
      AppRoutes.customerDashboard: (context) => const CustomerDashboardScreen(),
      AppRoutes.customerProfile: (context) => const Scaffold(
        body: Center(child: Text('Customer Profile - Coming Soon')),
      ),
      AppRoutes.deliveryDashboard: (context) => const DeliveryDashboardScreen(),
      AppRoutes.warehouseDashboard: (context) => const WarehouseDashboardScreen(),
      AppRoutes.warehouseInventory: (context) => const Scaffold(
        body: Center(child: Text('Warehouse Inventory - Coming Soon')),
      ),
    },
  );
