...
class _DeliveryConfirmationViewState extends State<DeliveryConfirmationView>
  ...
  Widget _buildManualConfirmation(DeliveryViewModel viewModel) {
    return Padding(
  ...
  Widget _buildCodeConfirmation(DeliveryViewModel viewModel) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
  ...
  Widget _buildQRConfirmation(DeliveryViewModel viewModel) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
