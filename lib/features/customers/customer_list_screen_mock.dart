...
class MockCustomer {
  ...
  MockCustomer({
    ...
    required this.creditLimit, required this.customerType, required this.status, required this.createdAt, required this.updatedAt, this.contactNumber,
    this.email,
    this.address,
  });
  final String id;
...
class CustomerCard extends StatelessWidget {
  ...
  const CustomerCard({
    required this.customer, required this.onTap, super.key,
  });
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: customerTypeColor.withValues(alpha: 0.1),
